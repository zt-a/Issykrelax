  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--background)" }}>
      <SEO
        ...
        description="Лучшие туры и экскурсии на Иссык-Куле, Кыргызстан: конные прогулки в Тянь-Шань, парусные яхтинг-прогулки по озеру, джип-сафари, треккинг, обзорные экскурсии в горах. Бронируйте онлайн."
        canonical="/tours"
