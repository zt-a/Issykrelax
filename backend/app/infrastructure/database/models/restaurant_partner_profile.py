...
class RestaurantPartnerProfileModel(Base):
    __tablename__ = "restaurant_partner_profiles"
    ...
    restaurants = relationship("RestaurantModel", back_populates="partner", cascade="all, delete-orphan")
