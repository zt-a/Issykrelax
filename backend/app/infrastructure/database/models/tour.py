...
class TourModel(Base):
    ...
    guide_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), ForeignKey("guide_profiles.id"), nullable=False, index=True)
    ...
    guide = relationship("GuideProfileModel", back_populates="tours")
